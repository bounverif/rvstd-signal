...
#define INT_MIN_ std::numeric_limits< int >::lowest()
...
TEST_CASE( "construction with common initilazer list" )
{
   ...
   std::vector< std::pair< int, int > > true_val = { { 0, 1 }, { 3, 2 }, { 6, INT_MIN_ }, { 7, 3 }, { 12, INT_MIN_ } };
   CHECK( is.get_data_vector() == true_val );
}

TEST_CASE( "construction with common initilazer list zero data" )
{
   ns::interval_map< int, int > is = { { { 0, 3 }, INT_MIN_ }, { { 3, 6 }, INT_MIN_ }, { { 7, 10 }, INT_MIN_ }, { { 10, 12 }, INT_MIN_ } };
...
TEST_CASE( "checking a time values with at() function " )
{
   ...
   std::vector< std::pair< int, int > > true_val = { { 0, 10 }, { 3, 20 }, { 6, 30 }, { 10, INT_MIN_ } };
   ...
   SECTION( " checking value when signal changed" )
   {
      ...
      CHECK( is3.at( 3 ) == 20 );
      CHECK( is3.at( 6 ) == 30 );
      CHECK( is3.at( 10 ) == INT_MIN_ );
   }
   SECTION( " cheking value at start and infinity" )
   {
      CHECK( is3.at( -1 ) == INT_MIN_ );
      CHECK( is3.at( 42 ) == INT_MIN_ );
   }
}
...
{
   ns::interval_map< int, int > is1{ { { { 1, 3 }, 1 }, { { 9, 11 }, 1 } } };
   ns::interval_map< int, int > is2{ { { { 5, 7 }, 1 } } };
   ns::interval_map< int, int > is3{ { { { 1, 2 }, 1 } } };
   ns::interval_map< int, int > is4{ { { { 1, 14 }, 1 } } };
   ns::interval_map< int, int > is5{ { { { 2, 4 }, 1 } } };
   ns::interval_map< int, int > is6{ { { { 2, 10 }, 1 } } };
...
{
   ns::interval_map< int, int > is1{ { { { 1, 3 }, 2 }, { { 9, 11 }, 2 } } };
   ns::interval_map< int, int > is2{ { { { 5, 7 }, 5 } } };
   ...
   ns::interval_map< int, int > is3{ { { { 1, 2 }, 5 } } };
   ...
   ns::interval_map< int, int > is3_2{ { { { 1, 2 }, 1 } } };
   ...
   ns::interval_map< int, int > is4{ { { { 1, 14 }, 5 } } };
   ...
   ns::interval_map< int, int > is4_2{ { { { 1, 14 }, 1 } } };
   ...
   ns::interval_map< int, int > is5{ { { { 2, 4 }, 5 } } };
   ...
   ns::interval_map< int, int > is5_2{ { { { 2, 4 }, 1 } } };
   ...
   ns::interval_map< int, int > is6{ { { { 2, 10 }, 5 } } };
   ...
   ns::interval_map< int, int > is6_2{ { { { 2, 10 }, 1 } } };
...
{
   ns::interval_map< int, int > is1{ { { { 2, 7 }, 1 }, { { 15, 21 }, 1 } } };
   ns::interval_map< int, int > is2{ { { { 3, 4 }, 1 } } };
   ns::interval_map< int, int > is3{ { { { 3, 4 }, 1 }, { { 16, 20 }, 1 } } };
   ns::interval_map< int, int > is4{ { { { 2, 7 }, 1 } } };
   ns::interval_map< int, int > is5{ { { { 2, 7 }, 1 }, { { 15, 21 }, 1 } } };
   ns::interval_map< int, int > is6{ { { { 5, 18 }, 1 } } };
   ns::interval_map< int, int > is7{ { { { 8, 10 }, 1 } } };
   ns::interval_map< int, int > is8{ { { { 7, 15 }, 1 } } };
   ns::interval_map< int, int > is9{ { { { 2, 21 }, 1 } } };
   ns::interval_map< int, int > is10{ { { { 1, 22 }, 1 } } };
...
{
   ns::interval_map< int, int > set_{ { { 10, 20 }, 1 }, { { 20, 45 }, 2 }, { { 46, 50 }, 3 } };
   auto test_val = not( set_ );

   ns::interval_map< int, int > true_val{ { { { 10, 20 }, -1 }, { { 20, 45 }, -2 }, { { 45, 46 }, 2147483647 }, { { 46, 50 }, -3 } }, std::numeric_limits< int >::max() };
   true_val.append( 50, 2147483647 );
   CHECK( test_val.get_data_vector() == true_val.get_data_vector() );
   CHECK( test_val.get_init() == true_val.get_init() );
}

TEST_CASE( "NOT operation with double" )
{
   ns::interval_map< int, double > set_{ { { 10, 20 }, 0.1 }, { { 20, 45 }, 0.2 }, { { 46, 50 }, 0.3 } };
   auto test_val = not( set_ );

   ns::interval_map< int, double > true_val{ { { { 10, 20 }, -0.1 }, { { 20, 45 }, -0.2 }, { { 45, 46 }, std::numeric_limits< double >::max() }, { { 46, 50 }, -0.3 } }, std::numeric_limits< double >::max() };
   true_val.append( 50, std::numeric_limits< double >::max() );
   CHECK( test_val.get_data_vector() == true_val.get_data_vector() );
   CHECK( test_val.get_init() == true_val.get_init() );
}
...
TEST_CASE( "set rules" )
{
   ...
   ns::interval_map< int, int > NULL_( INT_MIN_ );
...
TEST_CASE( "set rules with boolean" )
{
   ns::interval_map< int, bool > A = { { { -99, -95 }, 1 }, { { -93, -89 }, 1 }, { { -82, -80 }, 1 }, { { -66, -58 }, 1 }, { { -55, -52 }, 1 }, { { -42, -34 }, 1 }, { { -33, -15 }, 1 }, { { -13, -11 }, 1 }, { { -5, -1 }, 1 }, { { 2, 5 }, 1 }, { { 6, 17 }, 1 }, { { 42, 47 }, 1 }, { { 59, 67 }, 1 }, { { 85, 89 }, 1 }, { { 97, 100 }, 1 } };
   ns::interval_map< int, bool > B = { { { -94, -80 }, 1 }, { { -59, -48 }, 1 }, { { -40, -38 }, 1 }, { { -23, -9 }, 1 }, { { 6, 12 }, 1 }, { { 23, 38 }, 1 }, { { 46, 59 }, 1 }, { { 63, 69 }, 1 }, { { 72, 89 }, 1 }, { { 91, 92 }, 1 } };
   ns::interval_map< int, bool > C{ { { -84, -42 }, 1 }, { { -20, 17 }, 1 }, { { 22, 27 }, 1 }, { { 36, 38 }, 1 }, { { 52, 59 }, 1 } };
   ns::interval_map< int, bool > U( 1 );
   ns::interval_map< int, bool > NULL_( 0 );
